...
sink()
sink("output-tree-summary-lc7.txt", append=FALSE, split=TRUE)
print(tree2007.lc7)
...
sink()
sink("output-tree-summary-lc11.txt", append=FALSE, split=TRUE)
print(tree2007.lc11)
...
dev.off()
png("output-tree-lc7.png", width=700, height=500)
plot(tree2007.lc7)
...
dev.off()
png("output-tree-lc11.png", width=700, height=500)
plot(tree2007.lc11)
